...
\end{table}
 ...
 \section{Sean \(x, y \in \{0, 1, 2, 3\}\), desarrolla un comparador electrónico de 2 bits. Las salidas del comparador deben ser: \(x \geq y\). Para este ejercicio solo puedes usar compuertas, como AND, NOR, XOR, etc.}
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        01 & 1 & 1&  &  \\
        \hline
        11 & \textcolor{blue}{1} & \textcolor{blue}{1} & \textcolor{blue}{1} & \textcolor{blue}{1} \\
        \hline
        10 & 1& 1 &  & 1 \\
        \hline
    \end{tabular}
    \ \\
    Por lo tanto al final nos queda la expresion:
    \textcolor{red}{$\overline{y_0}$ $\overline{y_1}$} + \textcolor{green}{$x_1$ $\overline{y_0}$}+\textcolor{orange}{$x_0$ $\overline{y_0}$} + \textcolor{purple}{$x_0$ $\overline{y_1}$} + \textcolor{blue}{$x_0 x_1$}
